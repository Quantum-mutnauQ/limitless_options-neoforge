...
public class ValuesList extends ContainerObjectSelectionList<ValuesList.Entry> {
    public ValuesList(Minecraft p_94465_, int p_94466_, int p_94467_, int p_94468_, int p_94469_, int p_94470_) {
        super(p_94465_, p_94466_, p_94467_, p_94468_, p_94469_, p_94470_);
        this.centerListVertically = false;
    }

    public void add(OptionInstance<?> p_232531_, Font font) {
        this.addEntry(ValuesList.Entry.add(this.minecraft.options, this.width, p_232531_, font));
    }
    ...
    protected static class Entry extends ContainerObjectSelectionList.Entry<ValuesList.Entry> {
        ...
        public static ValuesList.Entry add(Options p_232538_, int p_232539_, OptionInstance<?> p_232540_, Font font) {
            ...
            if (p_232540_.get() instanceof Integer){
                ...
                editBox.setValue(String.format("%d", (Integer) p_232540_.get()));
            ...
            editBox.setResponder(s -> onChange(p_232540_,type,editBox));
        ...
        public static void onChange(OptionInstance<?> p_232540_,byte type, EditBox editBox){
            switch (type){
                case 1:
                    try {
