...
import quatum.limitless_options_forge.LimitlessOptions_Forge;
...
public class OpionssetterScreen extends Screen {
    ...
    protected void init() {
        this.list = new ValuesList(this.minecraft, this.width, this.height, 32, this.height - 32, 25);
        int i = -1;
        ...
        this.list.add(LimitlessOptions_Forge.OnScreenOptions,font);
